...
abstract class SwipeToDeleteCallback(private var context: Context) :
    ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {

    private val editIcon =
        ContextCompat.getDrawable(context, com.shail_singh.happyplaces.R.drawable.ic_delete)
    ...
    override fun onChildDraw(
        ...
        val movingX = (itemView.right + (dX)) - dX / 2
